...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { description: @welcome.description, name: @welcome.name, picture: @welcome.picture } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { description: @welcome.description, name: @welcome.name, picture: @welcome.picture } }
